...
theorem cappedEncodingTracedMappedAdversaryImpl_query_freshSigningCollisionsRepresented
    (publicKey : PublicKey) (secretKey : SecretKey)
    (baseCache : QueryCache HashSpec)
...
theorem cappedEncodingTracedMappedAdversaryImpl_freshSigningActionsRepresented
    (publicKey : PublicKey) (secretKey : SecretKey)
    (computation : OracleComp (OracleWorld + SigningSpec) α)
    (initialState : (QueryCache HashSpec × SigningCacheTrace) × EncodingActionTrace)
    (result : α ×
...
theorem cappedEncodingTracedMappedAdversaryImpl_unsignedEncodingEntriesRepresented
    (publicKey : PublicKey) (secretKey : SecretKey)
    (baseCache : QueryCache HashSpec)
    (computation : OracleComp (OracleWorld + SigningSpec) α)
    (initialState : (QueryCache HashSpec × SigningCacheTrace) × EncodingActionTrace)
...
theorem cappedEncodingTracedMappedAdversaryImpl_encodingCollisionInvariants
    (publicKey : PublicKey) (secretKey : SecretKey)
    (baseCache : QueryCache HashSpec)
    (hbaseEncodingFree : ∀ epoch input,
      baseCache (Concrete.CacheView.encodingInput secretKey.parameter epoch input) = none)
  ...
  | query_bind input next ih =>
      ...
      have hmiddleCollisions :=
        cappedEncodingTracedMappedAdversaryImpl_query_freshSigningCollisionsRepresented
...
theorem cappedDetailedGameAfterKeygenWithEncodingTrace_freshSigningActionsRepresented
    (adversary : Adversary Concrete.scheme)
    (publicKey : PublicKey) (secretKey : SecretKey)
    (initialCache : QueryCache HashSpec)
    (result : GameOutcome ×
  ...
  subst result
  have hrepresented :=
    cappedEncodingTracedMappedAdversaryImpl_freshSigningActionsRepresented
      publicKey secretKey (adversary.main publicKey) ((initialCache, []), [])
      (forgery, (adversaryState, encodingTrace))
...
theorem cappedDetailedGameAfterKeygenWithEncodingTrace_freshSigningCollisionsRepresented
    (adversary : Adversary Concrete.scheme)
    (publicKey : PublicKey) (secretKey : SecretKey)
    (initialCache : QueryCache HashSpec)
  ...
  simp only [support_pure, Set.mem_singleton_iff] at hfinal
  subst result
  have hinvariants := cappedEncodingTracedMappedAdversaryImpl_encodingCollisionInvariants
...
theorem cappedDetailedGameWithEncodingTrace_freshSigningActionsRepresented
    (adversary : Adversary Concrete.scheme)
    (result : GameOutcome ×
      ((QueryCache HashSpec × SigningCacheTrace) × EncodingActionTrace))
    (hmem : result ∈ support (cappedDetailedGameWithEncodingTrace adversary)) :
  ...
  obtain ⟨⟨⟨publicKey, secretKey⟩, keyCache⟩, _hkeygen, hrest⟩ := hmem
  have hrepresented :=
    cappedDetailedGameAfterKeygenWithEncodingTrace_freshSigningActionsRepresented adversary
      publicKey secretKey keyCache result hrest
  have hsecretKey :=
...
theorem cappedDetailedGameWithEncodingTrace_freshSigningCollisionsRepresented
    (adversary : Adversary Concrete.scheme)
    (result : GameOutcome ×
      ((QueryCache HashSpec × SigningCacheTrace) × EncodingActionTrace))
    (hmem : result ∈ support (cappedDetailedGameWithEncodingTrace adversary)) :
