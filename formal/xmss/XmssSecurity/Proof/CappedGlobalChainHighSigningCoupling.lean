import XmssSecurity.Proof.CappedGlobalChainHighKeygenCoupling
import XmssSecurity.Proof.CappedGlobalSigningTreeCacheCoupling
...
theorem relTriple_keygenViews_globalSign_run_full_baseHigh
    ...
    RelTriple
      ...
      ((simulateQ xmssRomImpl
        (Concrete.scheme.sign right.1.1.publicKey
