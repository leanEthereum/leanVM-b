import XmssSecurity.CappedChain.CausalStrategyEagerSteps
...
theorem CausalCacheExtendsKeygen.causalRecordedState
    ...
    CausalCacheExtendsKeygen
      (XmssSecurity.CappedChain.causalRecordedState secretKey chain input state) := by
...
theorem CausalCacheExtendsKeygen.causalRecordedStateCacheQuery
    ...
    CausalCacheExtendsKeygen
      { XmssSecurity.CappedChain.causalRecordedState secretKey chain input state with
        cache := (XmssSecurity.CappedChain.causalRecordedState
...
theorem CausalCacheExtendsKeygen.causalRevealResultState
    ...
    CausalCacheExtendsKeygen
      (XmssSecurity.CappedChain.causalRevealResultState secretKey chain input state
        index value output) := by
  rw [CausalCacheExtendsKeygen] at hextends ⊢
  unfold XmssSecurity.CappedChain.causalRevealResultState
    XmssSecurity.CappedChain.CausalHashState.recordReveal
