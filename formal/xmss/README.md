...
This Lean project formalizes the classical random-oracle security game from `doc/xmss/main.tex`. `XmssSecurity.Statement` contains the public statement without proof machinery. The main result is `xmss_has_127_bits_of_classical_security`, a machine-checked 127-bit theorem for `xmssScheme`.
