...
| [StructuralOracleObservation.lean](SphincsSecurity/Proof/StructuralOracleObservation.lean) | Exact lazy structural-row representation of the original reference experiment, retaining the graph and reference family. [StructuralMatchKernel.lean](SphincsSecurity/Proof/StructuralMatchKernel.lean) connects the verifier witness to a fresh-reply bound of $2^{-128}$ charged to other hash queries; adaptive accumulation remains required. |
