...
theorem sampledLiveNonSecretResidual_pairs_refund_le_reserved_add_residual
  ...
  unfold sampledLiveNonSecretResidual sampledPaidCoverageRefund sampledPaidCoverageResidual
  ...
  simpa only [initializedBeforeFailureSigningCharge, ← ENNReal.tsum_mul_right, mul_assoc,
    ...
    probEvent_liveNonSecretResidual_pairs_refund_le_reserved_add_residual adversary q hq hqMax parameter hp table
