...
theorem forgeAdvantage_le_answerEncoding_min_startPrefix_remaining127
  ...
  have hspace : q + 1 < Fintype.card Digest := by
    ...
    omega
  have hots := probEvent_sampledFirstParentOrOtsWitness_le_min_startPrefix_add_privateRisk adversary q hq hspace
