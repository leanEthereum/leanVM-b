import SphincsSecurity.Proof.OtsProbeJointTopStep
...
theorem relTriple_granularAllJointSnapshot_diagnostic
    ...
    RelTriple
      (granularAllCanonicalBoundaryWitnessSnapshot adversary parameter table ftsSecret q)
  ...
  unfold granularAllCanonicalBoundaryWitnessSnapshot
    observedMaterializedRetainedRunFromTable runDirectBoundaryWitnessSnapshotObserve
  rw [bind_assoc]
  change RelTriple
  ...
  exact relTriple_finishJointAfterPublishedRoot adversary parameter ftsSecret q table hbound leftResult
