...
theorem forgeAdvantage_le_answerEncoding_min_commonPrefix_remaining127
  ...
  have hspace : q + 1 < Fintype.card Digest := by
    ...
    omega
  have hots := probEvent_sampledFirstParentOrOtsWitness_le_min_common_prefix_charge adversary q hq hspace
