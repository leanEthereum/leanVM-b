import SphincsSecurity.Proof.OtsPrefixFrontier
...
theorem sampleOtsSecrets_eq_split (segment : OtsPrefix) :
  ...
  simp only [← PMF.monad_bind_eq_bind, ← PMF.monad_map_eq_map, evalDist_bind, map_eq_bind_pure_comp,
