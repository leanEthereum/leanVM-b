...
theorem forgeAdvantage_le_sharedHistory_add_outerCappedFts_remaining127
    ...
    forgeAdvantage scheme adversary ≤
      ...
      sampledOuterCappedErasedHistoryFtsWitnessRisk adversary q +
  ...
  exact add_le_add (add_le_add (add_le_add le_rfl
    (sampledNativeFtsWitnessRisk_le_outerCapped_erased_history adversary q hq (q + 1))) le_rfl) le_rfl
