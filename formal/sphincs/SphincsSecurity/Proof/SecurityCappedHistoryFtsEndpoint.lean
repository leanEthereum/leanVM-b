...
theorem forgeAdvantage_le_sharedHistory_add_cappedFts_remaining127
    ...
    forgeAdvantage scheme adversary ≤
      ...
      sampledCappedErasedHistoryFtsWitnessRisk adversary q +
  ...
  exact add_le_add (add_le_add (add_le_add le_rfl
    (sampledNativeFtsWitnessRisk_le_capped_erased_history adversary q hq (q + 1))) le_rfl) le_rfl
