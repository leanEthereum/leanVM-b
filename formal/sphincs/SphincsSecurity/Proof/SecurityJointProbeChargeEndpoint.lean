...
theorem forgeAdvantage_le_sharedHistory_add_jointProbeCharge_remaining127
  ...
  apply (forgeAdvantage_le_sharedHistory_add_jointFtsHit_remaining127 adversary q hqPos hq hqMax).trans
  exact add_le_add (add_le_add (add_le_add le_rfl
    (sampledJointRetainedFtsHitRisk_le_probeCharge adversary q)) le_rfl) le_rfl
