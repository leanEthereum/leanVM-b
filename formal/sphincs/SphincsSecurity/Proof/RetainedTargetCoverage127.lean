...
theorem probEvent_actualRetained_validObservedCover_le_127 (adversary : Adversary)
  ...
  rw [actualRetainedGameAfterSecrets, probEvent_bind_eq_tsum]
  calc
    _ ≤ ∑' rootResult, Pr[= rootResult | (simulateQ (randomOracle : QueryImpl HashSpec _)
      ...
      · apply mul_le_mul' le_rfl
        ...
        apply probEvent_adaptive_observedFewTimeCover_le_127 _ q hq _
...
theorem probEvent_actualRetained_validObservedCover_le_127_of_hashQueryBound (adversary : Adversary)
  ...
  probEvent_actualRetained_validObservedCover_le_127 adversary parameter otsSecret table q hq
