...
For the next numerical milestone, use the simpler [fixed-word variance route](variance-route.md): terminal length 25313293, coverage excess delta=2^-13, and split q=3*2^114. It replaces the Poisson moment and sharp tail work below by finite mixed factorial moments and a variance inequality. The adaptive coverage construction and cryptographic transfer obligations in this review remain necessary.
