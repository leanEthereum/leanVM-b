...
The fresh residual query law and the native probe and signing laws supply pieces of these checks. Composing them is still required. In particular, proving only the initial product prior cannot establish either original-game security interval.
