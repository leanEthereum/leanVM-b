...
//!    E-valued). This is [`super::tensor_algebra::TensorAlgebra`] retyped
//!    from the GHASH F128 to the tower [`F128T`]; the F_2 coordinates of an
//!    E element are the bits of its `(c0, c1)` tower representation.
//!
