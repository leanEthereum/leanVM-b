...
//! statements and four reduced fixed-table evaluations to its own public
//! input (doc.tex §Recursive aggregation, §Deferred evaluation claims).
//!
...
/// The mergeable deferred-claim data the guest batches into fixed-size claims
/// for the outer verifier (doc.tex §Deferred evaluation claims).
struct SubDefer {
    pi: [F128; 2],
    kbc: usize,
    zeta: Vec<F128>,
