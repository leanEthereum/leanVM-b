...
//! ratchet is needed. It is a Merkle-Damgard chain, NOT a sponge: there is no
...
/// split back into four field words. THE primitive; the chain is a chain of
...
impl FiatShamirState {
    ...
    pub fn new(label: &[u8], statement: &[F192]) -> Self {
        ...
        s.absorb_bytes(b"leanvm-b/transcript/v5-sha2");
