...
//! [`super::whir::commit`]), and one Ligerito run discharges
//!
...
/// evaluation AND the ring-switched q_flock claims (`ring`) in ONE Ligerito
...
pub fn open_batch_mixed_whir_stacked(
    ...
    ring_switch::combine_deferred_into(&rs_outputs, &mut b_stack[ring.offset..ring.offset + qflock_len]);
