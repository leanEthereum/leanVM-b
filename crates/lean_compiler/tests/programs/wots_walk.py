...
# dispatches it to a Const-specialized walker whose SHA3-256 chain is unrolled
# over heap slices (a 256-bit SHA3-256 value occupies two canonical cells);
...
def main():
    ...
    v[0] = t0
    v[1] = t1
    sha3_64(buf[2:4], buf[2:4], v)  # recompute H(value1, value1): asserts v[0:2] == (t0, t1)
    p = GEN ** 0
    p[1] = t0
    p[GEN] = t1
    return
