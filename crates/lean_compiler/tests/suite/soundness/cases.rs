...
fn digest_pins_its_preimage() {
    ...
    check_case(&Case {
        ...
        pokes: vec![
            ...
            wit("dig", 0, F192::ZERO),
            wit("dig", 1, F192::ZERO),
            wit("dig", 0, digest[0] + F192::ONE),
            wit("dig", 1, digest[1] + F192::ONE),
...
pub fn digest_5_7() -> [F192; 2] {
    let digest = lean_vm::vmhash::compress([F64(5), F64::ZERO, F64(7), F64::ZERO], [F64::ZERO; 4]);
    [
