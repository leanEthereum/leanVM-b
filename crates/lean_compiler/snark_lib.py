...
class _Elt:
    ...
    def __mul__(self, other):  # base-field product
        _ = other
        return _Elt()
...
def xor_192(a, b, out) -> None:
    """Add (XOR) two three-word extension-field StackBufs into `out`."""
    _ = a, b, out


def mul_192(a, b, out) -> None:
...
def blake3(
    ...
    *,
    ...
    """One standard BLAKE3 compression of two four-word message operands.
