...
% ---------- the jagged adapter (Annex C) ----------
\newcommand{\bval}[1]{\langle #1 \rangle}  % integer value of a little-endian
%                                          % bit string        (was \val, and
%                                          % \val is the memory value above)
\newcommand{\maj}{\mathrm{maj}}            % majority of three bits
