...
\newcommand{\kblock}{\kappa_{\mathrm{block}}} % variables in one BLAKE3 witness block
\newcommand{\kbatch}{\kappa_{\mathrm{batch}}} % log number of BLAKE3 instances
...
\newcommand{\lskip}{\upsilon_{\mathrm{lc}}}   % lincheck univariate challenge
\newcommand{\zpartial}{z_{\mathrm{partial}}}  % 64-entry lincheck residual
\newcommand{\lcab}{\alpha_{\mathrm{AB}}}      % lincheck A/B batching challenge
\newcommand{\lcpin}{\beta_{\mathrm{pin}}}     % lincheck constant-wire challenge
...
\newcommand{\md}{\mathrm{md}}       % BLAKE3 metadata immediate: counter, block length, flags
