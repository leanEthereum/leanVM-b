...
\noindent Bound variables keep the short names: $i,j,q$ index levels, rounds and queries; $u,v$ are cube points and $x$ a domain element; and $a$, $d_i$, $\varphi$, $t$, $B_1$, $B_2$, $\iota$ are local to the single proof or algorithm that introduces them.
