...
We use WHIR~\cite{ACFY25} / Ligerito~\cite{NA25} as inner-product commitment scheme (see annex \ref{annex:pcs}). The two are essentially the same scheme when WHIR is instantiated with interleaved codes and Ligerito with the Reed--Solomon codes.
