...
The packed flock witness $q_\pkd$ is the sole aligned exception. It occupies the offset-zero prefix so its ring-switch and fixed-slot claims retain their direct subcube formulas; all ordinary trace columns follow it in the tight jagged layout.
