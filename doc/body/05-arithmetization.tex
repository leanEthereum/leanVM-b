...
\emph{Fingerprint.} Index a tuple's coordinates by the four bits of $i$, its $m=12$ of them living in $16$ slots. The verifier samples $\alpha=(\alpha_0,\dots,\alpha_3)\in\E^{4}$ and maps each tuple $\btup$ to a single $\E$-element,
\[
...
\subsection{Batched zerocheck}\label{sec:air}
