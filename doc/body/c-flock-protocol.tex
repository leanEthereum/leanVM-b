...
Flock~\cite{Flock26} proves many executions of one Boolean circuit at once, in our case the BLAKE3 compression.
...
\end{equation}
Both sides evaluate the bilinear form by walking the BLAKE3 circuit backwards. That costs one circuit, against the roughly $21$ million nonzero entries the matrices hold.
