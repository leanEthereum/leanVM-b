...
\newcommand{\kblock}{\kappa_{\mathrm{block}}} % variables in one Keccak witness block
\newcommand{\kbatch}{\kappa_{\mathrm{batch}}} % log number of Keccak instances
...
\newcommand{\keccakf}{\mathrm{Keccak}\text{-}f}  % the 1600-bit permutation
