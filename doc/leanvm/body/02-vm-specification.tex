...
\texttt{BLAKE2S}        & $[o_{m_0},o_{m_1},o_{m_2},o_{m_3},o_{\mathit{cv}},o_{\mathit{out}},\md_0,\md_1]$ & BLAKE2s compression (see below)\\
\hline
\end{tabularx}
\end{center}
