...
leanVM-b is a candidate as the snark machinery required above. It's a verifiable virtual machine (commonly a zkVM, for "zero-knowledge virtual machine", though leanVM-b is not (yet) zk). It is based on binary fields, inspired by \cite{DP24} and \cite{Flock26}, currently using SHA3-256 \cite{fips202} as hash function.
