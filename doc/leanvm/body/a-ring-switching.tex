...
Ring switching was introduced in \cite{DP26}. We present a variant tailored to our use case: transforming a PCS for $K$ into a PCS for $\Ftwo$ (transforming a $K$-valued multilinear PCS, with $\nflock$ variables and opening claims in $E$, into a comitment protocol to 64 $\Ftwo$-valued multilinears, each with $\nflock$ variables and sharing opening claims in $E$). 
