...
\begin{enumerate}
\item \textbf{Verifier.} Sends the constraint-batch challenge $\eta$, each table taking a disjoint range of its powers, and the zerocheck point $r\in\F_{2^{128}}^n$, of which table $T_j$ uses the prefix $r_{<\tau_j}$.
