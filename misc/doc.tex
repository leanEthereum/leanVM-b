...
One further ring-switch operation is transparent but proof-dependent rather than fixed. For each of the two $128$-word messages $s_{t,a}$, the opening target contains
\[
